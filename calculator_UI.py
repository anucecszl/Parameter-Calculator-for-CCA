...
entropy_lb = Label(output_frame, text='entropy:')
enthalpy_lb = Label(output_frame, text='enthalpy:')
std_enthalpy_lb = Label(output_frame, text='std enthalpy:')
a_lb = Label(output_frame, text='mean radius:')
delta_lb = Label(output_frame, text='delta:')
vec_lb = Label(output_frame, text='VEC:')
std_vec_lb = Label(output_frame, text='std VEC:')
omega_lb = Label(output_frame, text='omega:')
tm_lb = Label(output_frame, text='Tm:')
std_tm_lb = Label(output_frame, text='std Tm:')
X_lb = Label(output_frame, text='X:')
std_X_lb = Label(output_frame, text='std X:')
